...
assert(type(LUAEX_INIT) == "boolean" and LUAEX_INIT, "LuaExAlt requires the LuaEx library during initialization. Please include and load the LuaEx library before initializing LuaExAlt.");
