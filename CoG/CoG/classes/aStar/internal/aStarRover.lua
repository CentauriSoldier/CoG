...
aStarRover = class "aStarRover" {
	...
	allowsEntryTo = function(this, other)
	...
	getMovePoints = function(this)
		return tRepo[this].movePoints:get();
	end,

	getMovePointsProtean = function(this)
		return tRepo[this].movePoints;
	end,
